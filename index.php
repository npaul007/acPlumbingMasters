			...
			<div class="row evenRow">
				<div class="container">
					...
					<div class="col-lg-6">
						...
						<h2 class="center-text">HVAC Unit Protection</h2>
						    <p>
			...
			<div class="row oddRow">
				<div class="container">
					<div class="col-lg-6">
						...
						<h2 class="center-text">Maintenance Contracts</h2>
						<p>To help extend the life of your furnace be sure to provide regular maintenance.</p>
						<p>We offer affordable yearly service contract for residential & light commercial customers.</p>
						<p>Sign up by calling us or making an appointment today!</p>
					</div>
					<div class="col-lg-6">
						<div class="icon-png center">
							<i class="fa fa-wrench" aria-hidden="true"></i>
						</div>
						<h2 class="center-text">New Unit Install  & Upgrades</h2>
					    <p>
							Reduce Energy Costs &
